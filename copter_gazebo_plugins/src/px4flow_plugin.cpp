...
#include "copter_msgs/OpticalFlow.h"
#include "copter_msgs/UltraSonicRange.h"


namespace gazebo
{   
  class PX4FlowPlugin : public ModelPlugin
  {

    public: PX4FlowPlugin()
    {

      // init ROS
      std::string name = "px4flow_plugin_node";
      int argc = 0;
    ...
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
        ...
        this->pub_PX4Flow = this->node->advertise<copter_msgs::OpticalFlow>("/px4flow/opt_flow",1000);
        this->pub_range = this->node->advertise<copter_msgs::UltraSonicRange>("/us_range",1000);
        ...
        this->updateConnection = event::Events::ConnectWorldUpdateBegin(
                   boost::bind(&PX4FlowPlugin::OnUpdate, this));
    ...
    public: void OnUpdate()
    {
          ...
          if ((current_time-last_time).toSec()>0.01)
          {
              ...
              range_msg.ground_distance = opt_msg.ground_distance;
    ...
    private: copter_msgs::OpticalFlow opt_msg;
    private: copter_msgs::UltraSonicRange range_msg;
  ...
  GZ_REGISTER_MODEL_PLUGIN(PX4FlowPlugin)
}
